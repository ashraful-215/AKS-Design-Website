...
<head>
    ...
    <style>
        ...
        .card:hover {
            box-shadow: 0px 8px 30px rgba(0, 0, 0, 0.5);/* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                               /* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */            /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                     /* [MD. Ashraful Islam Talukdar] */
            height: auto;
        }
...
/* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */
        .navbar .nav-link {
            color: #000 !important;
        }
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-transparent">
        <div class="container"><!-- [MD. Ashraful Islam Talukdar] -->
            ...
            <div class="row">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="imgbox">                                                                                                                                        <!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] -->                                                                                                                                                                        <!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] -->
