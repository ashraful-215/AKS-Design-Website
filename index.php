...
// LOGIN PROCESS CODE<!-- [MD. Ashraful Islam Talukdar] -->
if (isset($_POST['login'])) {
	$email = mysqli_real_escape_string($conn, $_POST['email']);
	$password = mysqli_real_escape_string($conn, $_POST['password']);

	$sqlLogin = "SELECT * FROM user WHERE email = '$email' AND status = 'active'";
	$resultLogin = mysqli_query($conn, $sqlLogin);// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]
	...
	if (mysqli_num_rows($resultLogin) == 1) {
		...
		if (strcmp(md5($password), $hashedPassword) == 0) { 
			// Passwords match, proceed with login<!-- [MD. Ashraful Islam Talukdar] -->
			$_SESSION['id'] = $rowLogin['uid'];
			$_SESSION['name'] = $rowLogin['name'];
			$_SESSION['role'] = $rowLogin['role'];

			// Redirect to appropriate dashboard based on user role<!-- [MD. Ashraful Islam Talukdar] -->
			if ($rowLogin['role'] == 'user') {
				...
				exit();// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]
			}
		} else {
...
if (isset($_POST['register'])) {
	...
	$otp = $_POST['otp'];// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]
	$activation_code = $_POST['activation_code'];
	$name = mysqli_real_escape_string($conn, $_POST['name']);
	$email = mysqli_real_escape_string($conn, $_POST['email']); //textfield er man variable e store korlam<!-- [MD. Ashraful Islam Talukdar] -->
...
// [MD. Ashraful Islam Talukdar]
		...
		echo $status = $selectRow['status'];// [MD. Ashraful Islam Talukdar]

		if ($status == 'active') {// [MD. Ashraful Islam Talukdar]
			...
			if ($updateResult) {// [MD. Ashraful Islam Talukdar]
				...
				$description = "Thank you for choosing AKS Design. As part of our commitment to ensuring the security of your account, we are sending you a One-Time Password (OTP) for verification purposes.Thank you for your cooperation. ";
				sendVerifcationEmail($email, $otp, $description);// [MD. Ashraful Islam Talukdar]
		...
		if ($insertResult) {// [MD. Ashraful Islam Talukdar]
		...
		<div class="left-side">
			...
			<form action="" method="POST">
				<div class="form-group">
					<label>Email</label><!-- [MD. Ashraful Islam Talukdar] -->
				...
				<div class="form-group">
					...
					} ?>" autocomplete="off" required><!-- [MD. Ashraful Islam Talukdar] -->
				</div>
...
<!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] -->
	<div class="wrapper display reg-left" id="signup-side">
		<div class="left-side signUp">
			...
			<form action="" method="POST" onsubmit="return validation()">
				...
				<div class="form-group">
					<label>Name</label><!-- [MD. Ashraful Islam Talukdar] -->
	...
	function validation() {
		...
		var namecheck = /^[A-Za-z. ]{3,30}$/;/* [MD. Ashraful Islam Talukdar] */
		...
		if (namecheck.test(name)) {
			...
			return false;/* [MD. Ashraful Islam Talukdar] */
		}
		...
		if (passwordcheck.test(password)) {/* [MD. Ashraful Islam Talukdar] */
			document.getElementById("passworderror").innerHTML = "";
		} else {
			document.getElementById("passworderror").innerHTML = "** Password is Invalid";/* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */
			return false;
		}
		if (password === confirm_password) {/* [MD. Ashraful Islam Talukdar] */
			document.getElementById("confirm_password_error").innerHTML = "";
		} else {
			document.getElementById("confirm_password_error").innerHTML = "** Passwords do not match";
			return false;
		}
		return true; // Ensure the form can be submitted if all validations pass/* [MD. Ashraful Islam Talukdar] */
	}
</script>
