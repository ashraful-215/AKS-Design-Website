...
$total_records_result = $conn->query($total_records_sql);// [MD. Ashraful Islam Talukdar]
...
<head>
    ...
    <style>
        ...
        .details-button {
            font-family: "Barlow", sans-serif;                                                                                                                                                                                                                      /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                    /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */
            font-weight: 600;
            text-align: center;
            ...
            font-size: 14px;
            line-height: 32px;
            color: #fff;                                                                                                                                                                                                                    /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                    /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                    /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                    /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                    /* [MD. Ashraful Islam Talukdar] */                                                                                                     /* [MD. Ashraful Islam Talukdar] */
...
<body>
    <div id="order-info" class="section">
        <div id="content">
            ...
            <table id="orderTable"><!-- [MD. Ashraful Islam Talukdar] -->
                <tr>
                    <th>ID</th>
                    <th>Name</th>
                    <th>Address</th>
