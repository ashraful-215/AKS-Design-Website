...
$conn = mysqli_connect($servername, $username, $password, $dbname);                                                                                                         // [MD. Ashraful Islam Talukdar]                                                                                                                                    // [MD. Ashraful Islam Talukdar]
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['admin_report']) && !empty($_POST['admin_report'])) {
        ...
        $reporter_uid = $_SESSION['id']; // [MD. Ashraful Islam Talukdar]
        ...
        $_SESSION['error_message'] = "Report field cannot be empty!";                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       // [MD. Ashraful Islam Talukdar]
    }
}
?>
...
<head>
    ...
    <style>
        ...
        #content {
            margin-left: 280px;                                                                                                                                                     /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                                                             /* [MD. Ashraful Islam Talukdar] */
            padding: 20px;
        }
        ...
        table {
            width: 100%;
            border-collapse: collapse;                                                                                                                                                   /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                                                             /* [MD. Ashraful Islam Talukdar] */
            margin-top: 20px;
        ...
        tr:hover {
            background-color: #f3e6c7;                                                                                                                                                   /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                                                             /* [MD. Ashraful Islam Talukdar] */
        }
        ...
        .details-button {
            font-family: "Barlow", sans-serif;                                                                          /* [MD. Ashraful Islam Talukdar] */
            font-weight: 600;
            text-align: center;
        ...
        .submit-button:hover {
            background-color: #fff;                                                                                                                                                   /* [MD. Ashraful Islam Talukdar] */                                                                                                                                                                                                                                                             /* [MD. Ashraful Islam Talukdar] */
            color: #55443a;
            border-color: #55443a;
        }
    </style>
...
<body>
    <div id="user-info" class="section">
        <div id="content">
            <h2>Admin Information</h2>                                                                                                      <!-- [MD. Ashraful Islam Talukdar] -->
