...
$user_id = isset($_POST['user_id']) ? $_POST['user_id'] : null; //checking user id// [MD. Ashraful Islam Talukdar]

$user_details = []; // array// [MD. Ashraful Islam Talukdar]
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_report'])) {
    ...
    if ($submit_action === 'report_user') {
        ...
        if (!empty($category) && !empty($reason)) {
            ...
            $violated_conn = mysqli_connect($servername, $username, $password, "aksviolated_user");// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]
            ...
            if (mysqli_query($violated_conn, $insert_sql)) {
                ...
                if (mysqli_query($conn, $delete_sql)) {// [MD. Ashraful Islam Talukdar]
        ...
        // Handle deactivation logic// [MD. Ashraful Islam Talukdar]
        $reason = mysqli_real_escape_string($conn, $_POST['reason']);
        // echo "User deactivated successfully. Reason: $reason";// [MD. Ashraful Islam Talukdar]
    }
}
...
<head>
    ...
    <title>User Information</title>                                                                                                                                                                                                                                                                                         <!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] -->
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        #reportButton {
            ...
            border: 1px solid #55443a;
            padding: 0 12px;
            font-size: 14px;/* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */
            line-height: 32px;
            color: #fff;
