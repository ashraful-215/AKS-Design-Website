...
// Fetch total number of users// [MD. Ashraful Islam Talukdar]
...
// Fetch total number of admins// [MD. Ashraful Islam Talukdar]
...
// Fetch total number of reported admins// [MD. Ashraful Islam Talukdar]
...
// Fetch total number of reported users from the user table in the violated_user database// [MD. Ashraful Islam Talukdar]
...
// Fetch total number of orders// [MD. Ashraful Islam Talukdar]
...
// Fetch total number of done orders// [MD. Ashraful Islam Talukdar]
$sqlDoneOrders = "SELECT COUNT(*) as total_done_orders FROM aksdesign.orders WHERE order_update = 'done'";                                                                                                                          // [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]
    ...
    <style>/* [MD. Ashraful Islam Talukdar] */
        * {
        ...
        #content main .box-info {
            ...
            grid-gap: 24px;/* [MD. Ashraful Islam Talukdar] */
            margin-top: 36px;
        }
...
<body>
    ...
    </section>                                                                                                                                                                                                                                  <!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] -->                                                                                                    <!-- [MD. Ashraful Islam Talukdar] --><!-- [MD. Ashraful Islam Talukdar] -->
