...
if ($conn->connect_error) {
    ...
    // echo "Connected successfully to the aksdesign database.<br>"; // Debug output// [MD. Ashraful Islam Talukdar]
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validating Password// [MD. Ashraful Islam Talukdar]
    ...
    // Validate Confirm Password// [MD. Ashraful Islam Talukdar]
    ...
    // Check input errors before inserting into database// [MD. Ashraful Islam Talukdar]
    if (empty($fullname_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        $stmt = $conn->prepare($sql);// [MD. Ashraful Islam Talukdar]
        ...
        if ($stmt->execute()) {
            echo "Record inserted successfully into the user table in aksdesign database.<br>"; // // [MD. Ashraful Islam Talukdar]Debug output
        ...
        // Close statement// [MD. Ashraful Islam Talukdar]
        $stmt->close();
    }
...
<head><!-- [MD. Ashraful Islam Talukdar] -->
    ...
    <title>Create Admin</title><!-- [MD. Ashraful Islam Talukdar] -->
    <style>/* [MD. Ashraful Islam Talukdar] */
        * {
        ...
        input {/* [MD. Ashraful Islam Talukdar] */
            font-family: "Barlow", sans-serif;
            width: 100%;
            background: #BEDCEE;
