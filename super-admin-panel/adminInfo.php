...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['admin_report']) && !empty($_POST['admin_report'])) {
        ...
        $uid = $_POST['uid'];// [MD. Ashraful Islam Talukdar]
...
/* [MD. Ashraful Islam Talukdar] */
        ...
        h2 {
            ...
            color: #64544B;/* [MD. Ashraful Islam Talukdar] */
            text-align: center;
            margin-left: 30px;
            margin-bottom: 30px;
            margin-top: 50px;
        ...
        td {
            color: black;/* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */
        }

        .details-button {
            font-family: "Barlow", sans-serif;
            font-weight: 600;/* [MD. Ashraful Islam Talukdar] */
            text-align: center;
...
<body><!-- [MD. Ashraful Islam Talukdar] -->
    ...
    <script>
        function toggleReportForm(button) {
            ...
            if (form.style.display === "none") {// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]// [MD. Ashraful Islam Talukdar]
