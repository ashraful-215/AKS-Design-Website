...
// Connect to the otp_verification database// [MD. Ashraful Islam Talukdar]
...
// Fetch reported admins from otp_verification database// [MD. Ashraful Islam Talukdar]
...
// Handle form submission// [MD. Ashraful Islam Talukdar]
if (isset($_POST['take_action'])) {
    $uid = $_POST['uid'];

    // Retrieve admin information from otp_verification database// [MD. Ashraful Islam Talukdar]
    ...
    if (mysqli_num_rows($result_admin) == 1) {
        ...
        // Connect to the violated_user database// [MD. Ashraful Islam Talukdar]
        $violated_conn = mysqli_connect("localhost", "root", "", "aksviolated_user");

        // Insert admin information into violated_user database// [MD. Ashraful Islam Talukdar]
        ...
        // Close violated_user database connection// [MD. Ashraful Islam Talukdar]
...
$sql = "SELECT * FROM user WHERE role = 'admin' LIMIT $offset, $records_per_page";// [MD. Ashraful Islam Talukdar]
...
<head>
    ...
    <style>/* [MD. Ashraful Islam Talukdar] */
        ...
        #content {/* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */
            margin-left: 280px;
            padding: 20px;
        }
        ...
        .action-button {
            font-family: "Barlow", sans-serif;                                                                                                                                                                                                                              /* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] *//* [MD. Ashraful Islam Talukdar] */
            font-weight: 600;
            text-align: center;
...
<body>
    <div id="content">
        ...
        <div style="margin-top: 20px; padding: 10px;  background-color: ; display: inline-block;"><!-- [MD. Ashraful Islam Talukdar] -->
            <span
